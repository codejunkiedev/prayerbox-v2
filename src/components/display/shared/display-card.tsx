...
export function DisplayCard({ children, width = 'md', padding = 'medium' }: DisplayCardProps) {
  ...
  const widthClasses = {
    ...
    lg: 'w-full max-w-lg sm:max-w-3xl md:max-w-4xl lg:max-w-5xl xl:max-w-6xl 2xl:max-w-screen-2xl [@media(min-width:3000px)]:max-w-[2310px] [@media(min-width:3800px)]:max-w-[2800px] [@media(min-width:4000px)]:max-w-[3200px]',
    xl: 'w-full max-w-xl sm:max-w-4xl md:max-w-5xl lg:max-w-6xl xl:max-w-7xl 2xl:max-w-screen-2xl [@media(min-width:3000px)]:max-w-[2800px] [@media(min-width:3800px)]:max-w-[3400px] [@media(min-width:4000px)]:max-w-[3800px]',
  };
