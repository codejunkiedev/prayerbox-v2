...
export const ayatAndHadithSchema = z.object({
  text: z.string().min(1, 'Ayat and Hadith text is required'),
  translation: z.string().min(1, 'Ayat and Hadith translation is required'),
  reference: z.string().min(1, 'Ayat and Hadith reference is required'),
